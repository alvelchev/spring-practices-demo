...
class UserRepositoryCriteriaImplTest {
    ...
    void testThat_getUsers_withUsernames_returnsResult() {
        ...
        // Act
        var result = underTest.getUsers(List.of(TEST_422_USERNAME), List.of(), List.of(), TEST_SEARCH_PARAMETER,
                mockPageable);
    ...
    void testThat_getUsers_withExcludeUsernames_returnsResult() {
        ...
        // Act
        var result = underTest.getUsers(List.of(), List.of(TEST_422_USERNAME), List.of(), TEST_SEARCH_PARAMETER,
                mockPageable);
    ...
    void testThat_getUsers_withLdapGroups_returnsResult() {
        ...
        // Act
        var result = underTest.getUsers(List.of(), List.of(TEST_422_USERNAME), List.of(LdapGroup.GENERAL), "",
                mockPageable);
